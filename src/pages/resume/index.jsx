        ...
        <div className="resume-container">
          <div className="resume-wrapper">
            ...
            <div className="exp-container">
              {Object.entries(experienceData).map(
                ([sectionTitle, sectionData]) =>
                  renderExperienceSection(sectionData, sectionTitle),
              )}
            </div>
            ...
            <div className="transferrable-skills">
              ...
              <h4>
                Drawing from my hospitality background, I've mastered swift,
                attentive service and meticulous attention to detail, vital in
                the time-sensitive and detail-oriented realm of makeup artistry
                and VFX makeup. My experience has ingrained in me stringent
                hygiene standards, keen customer insight, and robust
                organizational skills, essential for excelling in creative roles
                that demand precision, client understanding, and effective
                resource management. These transferable skills, coupled with my
                financial acumen from managing monetary transactions and
                inventory, make me uniquely equipped to deliver exceptional
